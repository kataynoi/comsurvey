    ...
    <div class="panel panel-info ">
        ...
        <div class="panel-body">
            ...
            <table id="table_data" class="table table-responsive">
                <thead>
                <tr>
                    <th>ID</th><th>ประเภทสวิทย์</th><th>ยี่ห้อ</th><th>รุ่น</th><th>ประเภทของPort</th><th>จำนวนPort</th><th>สถานที่ตั้ง</th><th>ปีที่เริ่มใช้งาน</th><th>สถานะการใช้งาน</th><th>หมายเลจครุภัณฑ์</th><th>IP</th>
                    <th>#</th>
                </tr>
                </thead>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control" id="row_id" placeholder="ROWID" value=""><div class="form-group">
                    ...
                    <input type="text" class="form-control" id="switch_series" placeholder="รุ่น" value=""></div><div class="form-group">
                    <label for="porttype">ประเภทของPort</label>
                    <input type="text" class="form-control" id="porttype" placeholder="ประเภทของPort" value=""></div><div class="form-group">
                    <label for="port"></label>
                    <input type="text" class="form-control" id="port" placeholder="" value=""></div><div class="form-group">
                    ...
                    <input type="text" class="form-control" id="start_use" placeholder="ปีที่เริ่มใช้งาน" value=""></div><div class="form-group">
                    ...
                    <input type="text" class="form-control" id="serial_number" placeholder="หมายเลจครุภัณฑ์" value=""></div><div class="form-group">
