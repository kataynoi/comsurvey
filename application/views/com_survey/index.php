...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> รายการคอมพิวเตอร์ สสจ.มหาสารคาม
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">เพิ่มรายการคอมพิวเตอร์ สสจ.มหาสารคาม</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="cbrand" placeholder="ยี่ห้อ" value=""></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ram" placeholder="RAM" value=""></div>
                <div class="form-group">
                    <label for="cpu">CPU</label>
                    <input type="text" class="form-control" id="cpu" placeholder="CPU" value=""></div>
                <div class="form-group">
                    <label for="harddisk">HDD</label>
                    <input type="text" class="form-control" id="harddisk" placeholder="HDD" value=""></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="co_workgroup" placeholder="กลุ่มงาน" value=""></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="start_year" placeholder="ปีที่เริ่มใช้งาน" value="">
                </div>
                <div class="form-group">
                    <label for="ups">UPS</label>
                    <input type="text" class="form-control" id="ups" placeholder="UPS" value=""></div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="serial_number" placeholder="หมายเลขครุภัณฑ์" value="">
                </div>
                <div class="form-group">
