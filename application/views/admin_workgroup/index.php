    ...
    <div class="panel panel-info ">
        ...
        <div class="panel-body">
            ...
            <table id="table_data" class="table table-responsive">
                <thead>
                <tr>
                    <th>รหัส</th><th>ชื่อกลุ่มงาน</th><th>เบอร์โทรกลุ่มงาน</th><th>FAX กลุ่มงาน</th><th>เลขสารบรรณกลุ่มงาน</th><th>หัวหน้ากลุ่มงาน</th><th>บันทึกเพิ่มเติม</th>
                    <th>#</th>
                </tr>
                </thead>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control" id="row_id" placeholder="ROWID" value=""><div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="ชื่อกลุ่มงาน" value=""></div><div class="form-group">
                    <label for="tel">เบอร์โทรกลุ่มงาน</label>
                    <input type="text" class="form-control" id="tel" placeholder="เบอร์โทรกลุ่มงาน" value=""></div><div class="form-group">
                    <label for="fax">FAX กลุ่มงาน</label>
                    <input type="text" class="form-control" id="fax" placeholder="FAX กลุ่มงาน" value=""></div><div class="form-group">
                    <label for="book_number">เลขสารบรรณกลุ่มงาน</label>
                    <input type="text" class="form-control" id="book_number" placeholder="เลขสารบรรณกลุ่มงาน" value=""></div><div class="form-group">
